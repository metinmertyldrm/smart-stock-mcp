...
export interface Telemetry {executionId?:string;traceId?:string;requestId?:string;planId?:string;model?:string;promptVersion?:string;applicationVersion?:string;environment?:string;startedAt?:string;finishedAt?:string;durationMs?:number;missingFields?:string[];actor?:AuditActor}
